...
import com.example.androiddevelopment.zadatakglumci.db.model.Filmovi;
import com.example.androiddevelopment.zadatakglumci.db.model.Glumci;
...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    private Dao<Glumci, Integer> mProductDao = null;
    private Dao<Filmovi, Integer> mCategoryDao = null;
    ...
    public Dao<Glumci, Integer> getProductDao() throws SQLException {
        if (mProductDao == null) {
            mProductDao = getDao(Glumci.class);
        }
    ...
    public Dao<Filmovi, Integer> getCategoryDao() throws SQLException {
        if (mCategoryDao == null) {
            mCategoryDao = getDao(Filmovi.class);
        }
